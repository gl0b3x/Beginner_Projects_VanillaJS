window.addEventListener('load', () => {
    ...
    form.addEventListener('submit', (e) => {
      ...
      task_check_el.id= "checkbox";
      task_check_el.type = "checkbox";
      const task_input_el = document.createElement("input");
      task_input_el.classList.add("text");
      task_input_el.type = "text";
      task_input_el.id = "texttask";
      ...
      task_check_el.addEventListener('click', () => {
        if(task_input_el.style.textDecoration == 'line-through') {
          task_input_el.style.textDecoration = null;
          task_input_el.style.color = "#2F4F4F";
          task_input_el.style.width = "570px"
          ...
          task_input_el.style.color = "#778899";
          task_actions_el.removeChild(task_edit_el);
          task_input_el.style.width = "620px"
        }
     })
